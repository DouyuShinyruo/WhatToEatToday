...
Page(Object.assign({}, Zan.TopTips, {
  data: {
    ...
    location: ["不限", "1F", "B1"],
    locationIndex: 0,
    eatType: ["不限", "面食", "中式快餐", "中餐厅", "西式快餐", "奶茶"],
    eatTypeIndex: 0
  },
  //事件处理函数
  ...
  //根据条件筛选出合适的列表
  dishesFillter(dishObjects, locationIndex, eatTypeIndex) {
    console.log("筛选", locationIndex, eatTypeIndex)
